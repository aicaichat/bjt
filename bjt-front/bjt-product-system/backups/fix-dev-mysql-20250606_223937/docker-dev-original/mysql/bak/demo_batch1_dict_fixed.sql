...
INSERT INTO `wp_bjt_shapes` (
  `id`, `product_line_id`, `code`, `name_zh`, `name_en`, `image_url`, `image_url2`, `status`, `sort_order`, `created_at`, `updated_at`
) VALUES
  (1, 1, 'pillow', '平袋', 'pillow', '/images/shop/MFB25.jpg', '/images/shop/MFB25_demo.jpg', 'publish', 10, NOW(), NOW()),
  (2, 1, 'bubble', '气泡袋', 'bubble', '/images/shop/MEX.JPG', '/images/shop/MEX_demo.JPG', 'publish', 20, NOW(), NOW()),
  (3, 1, 'tube', '筒状袋', 'tube', '/images/shop/MFC.jpg', '/images/shop/MFC_demo.jpg', 'publish', 30, NOW(), NOW()),
  (4, 2, 'square', '方袋', 'square', '/images/shop/ET2002.jpg', '/images/shop/ET2002_demo.jpg', 'publish', 40, NOW(), NOW()),
  (5, 3, 'tape', '胶带型', 'tape', '/images/shop/FR8003.jpg', '/images/shop/FR8003_demo.jpg', 'publish', 50, NOW(), NOW());
...
INSERT INTO `wp_bjt_specifications` (id, product_line_id, spec_type, metric_value, metric_unit, imperial_value, imperial_unit, status, sort_order, created_at, updated_at) VALUES
  (1, 1, 'thickness', 25.0, 'um', 1.0, 'mil', 'publish', 10, NOW(), NOW()),
  (2, 1, 'thickness', 50.0, 'um', 2.0, 'mil', 'publish', 20, NOW(), NOW()),
  (3, 1, 'width', 20.0, 'cm', 7.9, 'in', 'publish', 30, NOW(), NOW()),
  (4, 1, 'width', 40.0, 'cm', 15.7, 'in', 'publish', 40, NOW(), NOW()),
  (5, 1, 'length', 100.0, 'm', 328.1, 'ft', 'publish', 50, NOW(), NOW()),
  (6, 1, 'length', 200.0, 'm', 656.2, 'ft', 'publish', 60, NOW(), NOW()),
  (7, 2, 'weight', 120.0, 'gsm', 3.5, 'oz/yd²', 'publish', 70, NOW(), NOW()),
  (8, 2, 'weight', 180.0, 'gsm', 5.3, 'oz/yd²', 'publish', 80, NOW(), NOW());
