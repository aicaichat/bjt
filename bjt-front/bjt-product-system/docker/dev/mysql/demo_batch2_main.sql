...
INSERT INTO `wp_bjt_accessory_models` (`id`, `product_line_id`, `model`, `title_zh`, `title_en`, `description_zh`, `description_en`, `type`, `image1_url`, `image2_url`, `explosion_diagram_pdf`, `status`, `sort_order`, `created_at`, `updated_at`)
VALUES
...
-- 3. 主机料号（wp_bjt_parts）
INSERT INTO `wp_bjt_parts` (`id`, `product_line_id`, `model`, `voltage`, `image_url`, `part_number`, `name_zh`, `name_en`, `brand`, `spec`, `spec_imperial`, `package_size_cm`, `package_size_inch`, `net_weight_kg`, `net_weight_lbs`, `status`, `unit`, `created_at`, `updated_at`)
VALUES
  (1, 1, 'LA-E4S', '220V', '/images/shop/LA-E4S.jpg', '13A00001', 'E4S主机-标准版', 'E4S Host-Standard', 'BJT', '30x20x15cm', '11.8x7.9x5.9in', '35x25x20cm', '13.8x9.8x7.9in', 5.2, 11.46, 'publish', 'pcs', NOW(), NOW()),
  (2, 1, 'LA-E4S', '110V', '/images/shop/LA-E5P.jpg', '13A00002', 'E4S主机-美标版', 'E4S Host-US Version', 'BJT', '30x20x15cm', '11.8x7.9x5.9in', '35x25x20cm', '13.8x9.8x7.9in', 5.2, 11.46, 'publish', 'pcs', NOW(), NOW()),
  (3, 1, 'LA-E5P', '220V', '/images/shop/LA-E5P.jpg', '13A00003', 'E5P主机-标准版', 'E5P Host-Standard', 'BJT', '40x25x20cm', '15.7x9.8x7.9in', '45x30x25cm', '17.7x11.8x9.8in', 7.5, 16.53, 'publish', 'pcs', NOW(), NOW()),
  (4, 1, 'LA-E5P', '110V', '/images/shop/LA-E4C.jpg', '13A00004', 'E5P主机-美标版', 'E5P Host-US Version', 'BJT', '40x25x20cm', '15.7x9.8x7.9in', '45x30x25cm', '17.7x11.8x9.8in', 7.5, 16.53, 'publish', 'pcs', NOW(), NOW()),
  (5, 1, 'LA-E6L', '220V', '/images/shop/LA-E4C.jpg', '13A00005', 'E6L主机-标准版', 'E6L Host-Standard', 'BJT', '50x30x25cm', '19.7x11.8x9.8in', '55x35x30cm', '21.7x13.8x11.8in', 12.8, 28.22, 'publish', 'pcs', NOW(), NOW()),
  (6, 1, 'LA-E6L', '110V', '/images/shop/MPV.jpg', '13A00006', 'E6L主机-美标版', 'E6L Host-US Version', 'BJT', '50x30x25cm', '19.7x11.8x9.8in', '55x35x30cm', '21.7x13.8x11.8in', 12.8, 28.22, 'publish', 'pcs', NOW(), NOW()),
  (7, 2, 'PM-100', '220V', '/images/shop/ET2002.jpg', '23P00001', 'PM100主机-标准版', 'PM100 Host-Standard', 'BJT', '70x45x50cm', '27.6x17.7x19.7in', '75x50x55cm', '29.5x19.7x21.7in', 35.0, 77.16, 'publish', 'pcs', NOW(), NOW()),
  (8, 2, 'PM-100', '110V', '/images/shop/ET1003.jpg', '23P00002', 'PM100主机-美标版', 'PM100 Host-US Version', 'BJT', '70x45x50cm', '27.6x17.7x19.7in', '75x50x55cm', '29.5x19.7x21.7in', 35.0, 77.16, 'publish', 'pcs', NOW(), NOW()),
  (9, 2, 'PM-200', '220V', '/images/shop/ET1003.jpg', '23P00003', 'PM200主机-标准版', 'PM200 Host-Standard', 'BJT', '80x50x55cm', '31.5x19.7x21.7in', '85x55x60cm', '33.5x21.7x23.6in', 42.0, 92.59, 'publish', 'pcs', NOW(), NOW()),
  (10, 2, 'PM-200', '110V', '/images/shop/LA-E5P.jpg', '23P00004', 'PM200主机-美标版', 'PM200 Host-US Version', 'BJT', '80x50x55cm', '31.5x19.7x21.7in', '85x55x60cm', '33.5x21.7x23.6in', 42.0, 92.59, 'publish', 'pcs', NOW(), NOW()),
  (11, 3, 'TM-200', '220V', '/images/shop/FR8003.jpg', '33T00001', 'TM200主机-标准版', 'TM200 Host-Standard', 'BJT', '60x40x30cm', '23.6x15.7x11.8in', '65x45x35cm', '25.6x17.7x13.8in', 18.2, 40.12, 'publish', 'pcs', NOW(), NOW()),
  (12, 3, 'TM-200', '110V', '/images/shop/EC2005.jpg', '33T00002', 'TM200主机-美标版', 'TM200 Host-US Version', 'BJT', '60x40x30cm', '23.6x15.7x11.8in', '65x45x35cm', '25.6x17.7x13.8in', 18.2, 40.12, 'publish', 'pcs', NOW(), NOW()),
  (13, 4, 'ACB-100', '220V', '/images/shop/MPV.jpg', '43B00001', 'ACB100主机-标准版', 'ACB100 Host-Standard', 'BJT', '40x20x15cm', '15.7x7.9x5.9in', '45x25x20cm', '17.7x9.8x7.9in', 8.5, 18.74, 'publish', 'pcs', NOW(), NOW()),
  (14, 4, 'ACB-100', '110V', '/images/shop/LA-E4S.jpg', '43B00002', 'ACB100主机-美标版', 'ACB100 Host-US Version', 'BJT', '40x20x15cm', '15.7x7.9x5.9in', '45x25x20cm', '17.7x9.8x7.9in', 8.5, 18.74, 'publish', 'pcs', NOW(), NOW());

-- 4. 配件料号（wp_bjt_accessories）
INSERT INTO `wp_bjt_accessories` (`id`, `product_line_id`, `model`, `brand`, `part_number`, `name_zh`, `name_en`, `spec`, `spec_imperial`, `voltage`, `frequency`, `image_url`, `status`, `unit`, `created_at`, `updated_at`)
VALUES
  (1, 1, 'E4S-FAN', 'BJT', 'A10001', 'E4S风扇组件', 'E4S Fan Assembly', '12x8x6cm', '4.7x3.1x2.4in', '220V', '50Hz', '/images/shop/LA-E4S.jpg', 'publish', 'pcs', NOW(), NOW()),
  (2, 1, 'E4S-FAN', 'BJT', 'A10002', 'E4S风扇组件-美规', 'E4S Fan Assembly-US', '12x8x6cm', '4.7x3.1x2.4in', '110V', '60Hz', '/images/shop/LA-E5P.jpg', 'publish', 'pcs', NOW(), NOW()),
  (3, 1, 'E4S-CTRL', 'BJT', 'A20001', 'E4S控制板组件', 'E4S Controller Assembly', '10x8x3cm', '3.9x3.1x1.2in', '220V', '50Hz', '/images/shop/LA-E5P.jpg', 'publish', 'pcs', NOW(), NOW()),
  (4, 1, 'E4S-HEATER', 'BJT', 'A30001', 'E4S加热器组件', 'E4S Heater Assembly', '15x10x8cm', '5.9x3.9x3.1in', '220V', '50Hz', '/images/shop/LA-E4C.jpg', 'publish', 'pcs', NOW(), NOW()),
  (5, 1, 'E4S-FAN-CHILD', 'BJT', 'A40001', 'E4S风扇子件组件', 'E4S Fan Child Assembly', '8x6x3cm', '3.1x2.4x1.2in', '220V', '50Hz', '/images/shop/MPV.jpg', 'publish', 'pcs', NOW(), NOW()),
  (6, 2, 'PM100-CUTTER', 'BJT', 'B10001', 'PM100切刀组件', 'PM100 Cutter Assembly', '20x5x2cm', '7.9x2.0x0.8in', '220V', '50Hz', '/images/shop/ET2002.jpg', 'publish', 'pcs', NOW(), NOW()),
  (7, 2, 'PM100-ROLLER', 'BJT', 'B20001', 'PM100滚轮组件', 'PM100 Roller Assembly', '10x4x4cm', '3.9x1.6x1.6in', '220V', '50Hz', '/images/shop/ET1003.jpg', 'publish', 'pcs', NOW(), NOW()),
  (8, 3, 'TM200-BLADE', 'BJT', 'C10001', 'TM200刀片组件', 'TM200 Blade Assembly', '5x2x0.5cm', '2.0x0.8x0.2in', '220V', '50Hz', '/images/shop/FR8003.jpg', 'publish', 'pcs', NOW(), NOW()),
  (9, 3, 'TM200-SPRING', 'BJT', 'C20001', 'TM200弹簧组件', 'TM200 Spring Assembly', '3x1x1cm', '1.2x0.4x0.4in', '220V', '50Hz', '/images/shop/EC2005.jpg', 'publish', 'pcs', NOW(), NOW()),
  (10, 4, 'ACB100-VALVE', 'BJT', 'D10001', 'ACB100气阀组件', 'ACB100 Valve Assembly', '6x3x3cm', '2.4x1.2x1.2in', '220V', '50Hz', '/images/shop/MPV.jpg', 'publish', 'pcs', NOW(), NOW());
...
INSERT INTO `wp_bjt_spare_parts` (
  `id`, `product_line_id`, `model`, `app_model`, `is_consumable`, `image_url`, `part_number`, `name_zh`, `name_en`, `spec`, `spec_imperial`, `app_sn`, `status`, `unit`, `created_at`, `updated_at`)
VALUES
  (1, 1, 'SPR-100', 'LA-E4S', 0, '/images/shop/MPV.jpg', '16P00001', 'E4S气泵皮膜', 'E4S Pump Membrane', '8x8x0.2cm', '3.1x3.1x0.08in', 'All', 'publish', 'pcs', NOW(), NOW()),
  (2, 1, 'SPR-200', 'LA-E4S,LA-E5P', 0, '/images/shop/LA-F2.jpg', '16P00002', 'E4S加热丝', 'E4S Heating Wire', '15cm长', '5.9in length', 'All', 'publish', 'pcs', NOW(), NOW()),
  (3, 1, 'SPR-100', 'LA-E5P', 0, '/images/shop/MPV.jpg', '16P00003', 'E5P气泵皮膜', 'E5P Pump Membrane', '10x10x0.3cm', '3.9x3.9x0.12in', 'All', 'publish', 'pcs', NOW(), NOW()),
  (4, 1, 'SPR-200', 'LA-E5P', 0, '/images/shop/LA-F2.jpg', '16P00004', 'E5P加热丝', 'E5P Heating Wire', '20cm长', '7.9in length', 'All', 'publish', 'pcs', NOW(), NOW()),
  (5, 2, 'SPR-300', 'PM-100', 0, '/images/shop/ET2002.jpg', '26P00001', 'PM100切纸刀片', 'PM100 Cutting Blade', '30cm长', '11.8in length', 'All', 'publish', 'pcs', NOW(), NOW()),
  (6, 2, 'SPR-300', 'PM-200', 0, '/images/shop/ET1003.jpg', '26P00002', 'PM200切纸刀片', 'PM200 Cutting Blade', '35cm长', '13.8in length', 'All', 'publish', 'pcs', NOW(), NOW()),
  (7, 3, 'SPR-400', 'TM-200', 0, '/images/shop/FR8003.jpg', '36P00001', 'TM200切刀', 'TM200 Cutter', '8cm长', '3.1in length', 'All', 'publish', 'pcs', NOW(), NOW()),
  (8, 3, 'SPR-400', 'TM-300', 0, '/images/shop/EC2005.jpg', '36P00002', 'TM300切刀', 'TM300 Cutter', '10cm长', '3.9in length', 'All', 'publish', 'pcs', NOW(), NOW()),
  (9, 4, 'SPR-100', 'ACB-100', 0, '/images/shop/MPV.jpg', '46B00001', 'ACB100气阀皮膜', 'ACB100 Valve Membrane', '5x5x0.2cm', '2.0x2.0x0.08in', 'All', 'publish', 'pcs', NOW(), NOW()),
  (10, 4, 'SPR-100', 'ACB-200', 0, '/images/shop/LA-E4S.jpg', '46B00002', 'ACB200气阀皮膜', 'ACB200 Valve Membrane', '6x6x0.2cm', '2.4x2.4x0.08in', 'All', 'publish', 'pcs', NOW(), NOW());

-- 7. 备件型号（wp_bjt_spare_part_models）
INSERT INTO `wp_bjt_spare_part_models` (`id`, `product_line_id`, `model`, `title_zh`, `title_en`, `description_zh`, `description_en`, `type`, `image1_url`, `image2_url`, `explosion_diagram_pdf`, `status`, `sort_order`, `created_at`, `updated_at`)
VALUES
  (1, 1, 'SPR-300', 'E4S必选备件', 'E4S Required Spare Part', '10x10x0.3cm', '3.9x3.9x0.12in', 'All', NULL, NULL, NULL, 'publish', 10, NOW(), NOW()),
  (2, 2, 'SPR-400', 'PM100必选备件', 'PM100 Required Spare Part', '30cm长', '11.8in length', 'All', NULL, NULL, NULL, 'publish', 20, NOW(), NOW()),
  (3, 3, 'SPR-500', 'TM200必选备件', 'TM200 Required Spare Part', '8cm长', '3.1in length', 'All', NULL, NULL, NULL, 'publish', 30, NOW(), NOW()),
  (4, 4, 'SPR-600', 'ACB100必选备件', 'ACB100 Required Spare Part', '5x5x0.2cm', '2.0x2.0x0.08in', 'All', NULL, NULL, NULL, 'publish', 40, NOW(), NOW()); 