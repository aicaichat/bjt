...
const ProductLine2Page: React.FC = () => {
  ...
  return (
    <div className="machines-page ms-product-line-layout min-h-screen bg-gray-50 text-gray-900">
      ...
      <div className="bg-white rounded-lg shadow-md p-4 mb-6 text-gray-900 border border-gray-200 transition-colors duration-300">
        ...
        {/* Product Type Filter - ProductLine2 特有 - 图片卡片式 - 第一位 */}
            ...
            <div className="slide-up" style={{ animationDelay: '0.1s' }}>
              <div className="flex items-center space-x-3 mb-6">
                ...
                <h4 className="text-base font-semibold text-gray-800">
                  {t('filters.selectProductType') || '选择产品类型'}
                </h4>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
                ...
                <div className="relative">
                  ...
                  <label 
                    htmlFor="type-all" 
                    className={`block p-5 rounded-xl border-2 cursor-pointer transition-all duration-300 text-center ${
                  ...
                  >
                    ...
                    <div className={`text-base font-medium transition-colors duration-200 flex flex-col items-center ${
                      selectedProductType === 'ALL' ? 'text-blue-700' : 'text-gray-700'
                    }`}>
                      <span>{t('filters.allTypes') || '全部类型'}</span>
                ...
                <div className="relative">
                  <input 
                    ...
                    name="productType" 
                    className="sr-only" 
                    checked={selectedProductType === '填充'}
                    onChange={() => setSelectedProductType('填充')}
                  />
                  <label 
                    htmlFor="type-fill" 
                    className={`block p-5 rounded-xl border-2 cursor-pointer transition-all duration-300 text-center ${
                      selectedProductType === '填充' 
                        ? 'border-blue-500 bg-blue-50 shadow-lg scale-105' 
                        : 'border-gray-200 bg-white hover:border-blue-300 hover:shadow-md hover:bg-blue-25'
                    }`}
                  >
                    <div className="mb-4 flex justify-center">
                      <img 
                        src="/images/product-types/fill.png" 
                        alt="填充" 
                    ...
                    <div className={`text-base font-medium transition-colors duration-200 flex flex-col items-center ${
                      selectedProductType === '填充' ? 'text-blue-700' : 'text-gray-700'
                    }`}>
                      <span>填充</span>
                      <span className="text-xs mt-1 text-blue-500">
                        ({machines.filter(m => (m as any).type === '填充').length})
                      </span>
                    </div>
                    {selectedProductType === '填充' && (
                      <div className="absolute -top-1 -right-1 w-7 h-7 bg-blue-500 rounded-full flex items-center justify-center">
                ...
                <div className="relative">
                  <input 
                    ...
                    name="productType" 
                    className="sr-only" 
                    checked={selectedProductType === '缓冲'}
                    onChange={() => setSelectedProductType('缓冲')}
                  />
                  <label 
                    htmlFor="type-cushion" 
                    className={`block p-5 rounded-xl border-2 cursor-pointer transition-all duration-300 text-center ${
                      selectedProductType === '缓冲' 
                        ? 'border-blue-500 bg-blue-50 shadow-lg scale-105' 
                        : 'border-gray-200 bg-white hover:border-blue-300 hover:shadow-md hover:bg-blue-25'
                    }`}
                  >
                    <div className="mb-4 flex justify-center">
                      <img 
                        src="/images/product-types/cushion.png" 
                        alt="缓冲" 
                        className="h-28 w-32 object-contain"
                        onError={(e) => {
                          const target = e.target as HTMLImageElement;
                    ...
                    <div className={`text-base font-medium transition-colors duration-200 flex flex-col items-center ${
                      selectedProductType === '缓冲' ? 'text-blue-700' : 'text-gray-700'
                    }`}>
                      <span>缓冲</span>
                      <span className="text-xs mt-1 text-blue-500">
                        ({machines.filter(m => (m as any).type === '缓冲').length})
                      </span>
                    </div>
                    {selectedProductType === '缓冲' && (
                      <div className="absolute -top-1 -right-1 w-7 h-7 bg-blue-500 rounded-full flex items-center justify-center">
                ...
                <div className="relative">
                  <input 
                    ...
                    name="productType" 
                    className="sr-only" 
                    checked={selectedProductType === '包裹'}
                    onChange={() => setSelectedProductType('包裹')}
                  />
                  <label 
                    htmlFor="type-wrap" 
                    className={`block p-5 rounded-xl border-2 cursor-pointer transition-all duration-300 text-center ${
                      selectedProductType === '包裹' 
                        ? 'border-blue-500 bg-blue-50 shadow-lg scale-105' 
                        : 'border-gray-200 bg-white hover:border-blue-300 hover:shadow-md hover:bg-blue-25'
                    }`}
                  >
                    <div className="mb-4 flex justify-center">
                      <img 
                        src="/images/product-types/wrap.png" 
                        alt="包裹" 
                        className="h-28 w-32 object-contain"
                        onError={(e) => {
                          const target = e.target as HTMLImageElement;
                    ...
                    <div className={`text-base font-medium transition-colors duration-200 flex flex-col items-center ${
                      selectedProductType === '包裹' ? 'text-blue-700' : 'text-gray-700'
                    }`}>
                      <span>包裹</span>
                      <span className="text-xs mt-1 text-blue-500">
                        ({machines.filter(m => (m as any).type === '包裹').length})
                      </span>
                    </div>
                    {selectedProductType === '包裹' && (
                      <div className="absolute -top-1 -right-1 w-7 h-7 bg-blue-500 rounded-full flex items-center justify-center">
...
export default ProductLine2Page;