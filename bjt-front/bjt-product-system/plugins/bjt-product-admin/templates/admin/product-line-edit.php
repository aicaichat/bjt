...
$product_line_id = isset($_GET['product_line']) ? intval($_GET['product_line']) : 0;
$product_line = BJT_Product_Line_Management::get_instance()->get_product_line($product_line_id);

// Set default values if product line doesn't exist
if (!$product_line) {
    $product_line = array(
        'id' => 0,
        'title_cn' => '',
...
<div class="wrap">
    <h1 class="wp-heading-inline">
        <?php echo sprintf(__('编辑产品线 %d', 'bjt-product-admin'), $product_line_id); ?>
    </h1>
    ...
    <form id="product-line-form" method="post">
        ...
        <input type="hidden" name="product_line_id" value="<?php echo $product_line_id; ?>">
            ...
            <div class="language-content active" data-lang="cn">
                <div class="text-editor">
                    <div class="editor-toolbar">
                        ...
                        <button type="button" class="editor-btn" data-command="code">⌨️</button>
                    </div>
                    <?php 
                    wp_editor(
        ...
        <!-- Subitem 1 (Consumables) -->
        <div class="form-group">
            <label><?php _e('子项1（耗材）：', 'bjt-product-admin'); ?></label>
            <div class="language-tabs">
                <div class="language-tab active" data-lang="cn"><?php _e('中文', 'bjt-product-admin'); ?></div>
                <div class="language-tab" data-lang="en">English</div>
            </div>
        ...
        <!-- Subitem 2 (Parts) -->
        <div class="form-group">
            <label><?php _e('子项2（备件）：', 'bjt-product-admin'); ?></label>
            <div class="language-tabs">
                <div class="language-tab active" data-lang="cn"><?php _e('中文', 'bjt-product-admin'); ?></div>
                <div class="language-tab" data-lang="en">English</div>
            </div>
        ...
        <div class="form-group">
            ...
            <div class="image-upload-area" id="dropArea">
                <img id="previewImage" src="<?php echo $product_line['image'] ? 
                    ...
                    '/api/placeholder/320/200'; ?>" alt="preview">
...
jQuery(document).ready(function($) {
    ...
    function uploadFile(file) {
        ...
        formData.append('product_line_id', <?php echo $product_line_id; ?>);
