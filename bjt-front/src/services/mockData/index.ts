...
// 导入所有可用的mock数据
import { mockMachines, mockAccessories, mockLevel2Accessories, mockLevel3Accessories, mockLevel4Accessories, mockLevel5Accessories } from './machinesMock';
...
import { mockSpareParts } from './sparePartsMock';
